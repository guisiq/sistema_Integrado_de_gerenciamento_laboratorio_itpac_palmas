...
var url = "https://api-sig-itpac-84633.herokuapp.com/api/professores";
// var urlPatch =
...
export default {
  ...
  methods: {
    ...
    checkForm() {
      if (
        this.itemEditado.pessoa.cpf &&
        this.itemEditado.pessoa.nome &&
        this.itemEditado.pessoa.telefone &&
        this.itemEditado.pessoa.email
      ) {
        this.salvar();
        return true;
      }
